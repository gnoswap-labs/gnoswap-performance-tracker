...
| Swap (fee 100, 10 staked tick-crosses after accumulation) | 100,940,569 | 34,659 | 96,146,264 |
| Swap (fee 100, 100 staked tick-crosses after accumulation) | 883,450,236 | 327,778 | 846,623,818 |
| Swap (fee 100, 50 staked tick-crosses after accumulation) | 432,616,415 | 164,969 | 415,803,234 |
| Swap (fee 10000, 1 staked tick-crosses after accumulation) | 30,660,774 | 5,450 | 29,054,599 |
| Swap (fee 10000, 10 staked tick-crosses after accumulation) | 107,277,265 | 34,700 | 102,426,089 |
| Swap (fee 10000, 5 staked tick-crosses after accumulation) | 64,889,292 | 18,449 | 61,878,486 |
| Swap (fee 500, 1 staked tick-crosses after accumulation) | 29,736,079 | 5,447 | 28,145,227 |
| Swap (fee 500, 10 staked tick-crosses after accumulation) | 103,003,496 | 34,671 | 98,205,172 |
| Swap (fee 500, 50 staked tick-crosses after accumulation) | 446,899,772 | 165,049 | 429,898,379 |
...
| Swap (1 staked tick-cross after 0 prior tick checkpoints) | 29,745,785 | 5,457 | 28,145,265 |
| Swap (1 staked tick-cross after 1 prior tick checkpoints) | 32,323,794 | 3,392 | 30,882,088 |
| Swap (1 staked tick-cross after 2 prior tick checkpoints) | 33,490,690 | 3,337 | 32,038,308 |
| Swap (1 staked tick-cross after 3 prior tick checkpoints) | 32,890,781 | 3,338 | 31,445,256 |
| Swap (1 staked tick-cross after 4 prior tick checkpoints) | 33,653,113 | 7,583 | 32,174,197 |
| Swap (1 staked tick-cross after 5 prior tick checkpoints) | 32,978,041 | 3,384 | 31,520,758 |
| Swap (1 staked tick-cross after 6 prior tick checkpoints) | 33,646,223 | 3,338 | 32,177,699 |
| Swap (1 staked tick-cross after 7 prior tick checkpoints) | 33,110,317 | 5,410 | 31,635,076 |
| Swap (1 staked tick-cross after 8 prior tick checkpoints) | 33,643,911 | 3,374 | 32,172,213 |
| Swap (1 staked tick-cross after 9 prior tick checkpoints) | 33,021,810 | 3,344 | 31,557,392 |
| Swap (1 staked tick-cross after 10 prior tick checkpoints) | 33,756,249 | 5,386 | 32,266,533 |
| Swap (1 staked tick-cross after 11 prior tick checkpoints) | 33,045,662 | 3,363 | 31,578,148 |
| Swap (1 staked tick-cross after 12 prior tick checkpoints) | 33,708,102 | 3,339 | 32,229,351 |
| Swap (1 staked tick-cross after 13 prior tick checkpoints) | 33,325,241 | 9,898 | 31,818,285 |
| Swap (1 staked tick-cross after 14 prior tick checkpoints) | 33,777,481 | 3,411 | 32,287,216 |
| Swap (1 staked tick-cross after 15 prior tick checkpoints) | 33,151,531 | 3,336 | 31,668,564 |
| Swap (1 staked tick-cross after 16 prior tick checkpoints) | 33,893,642 | 5,392 | 32,385,383 |
| Swap (1 staked tick-cross after 17 prior tick checkpoints) | 33,155,515 | 3,360 | 31,669,470 |
| Swap (1 staked tick-cross after 18 prior tick checkpoints) | 33,795,886 | 3,338 | 32,298,607 |
| Swap (1 staked tick-cross after 19 prior tick checkpoints) | 33,404,702 | 7,713 | 31,886,393 |
| Swap (1 staked tick-cross after 20 prior tick checkpoints) | 33,805,778 | 3,384 | 32,306,036 |
| Swap (1 staked tick-cross after 32 prior tick checkpoints) | 33,939,056 | 3,434 | 32,411,566 |
| Swap (1 staked tick-cross after 64 prior tick checkpoints) | 34,112,858 | 5,572 | 32,560,575 |
| CollectReward after 65 tick checkpoints | 13,098,012 | 2,086 | 12,285,909 |
