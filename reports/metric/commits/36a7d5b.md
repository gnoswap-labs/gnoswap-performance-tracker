...
| Remaining pool repeat no-cross exact-in forward stage-100 | 2,292,068,425 | 69 | 2,196,986,974 |
| Remaining pool repeat no-cross exact-in forward stage-1000 | 23,145,065,580 | 83 | 22,191,530,610 |
| Remaining pool repeat no-cross exact-in reverse stage-1 | 24,914,431 | 3,070 | 23,886,147 |
| Remaining pool repeat no-cross exact-in reverse stage-10 | 245,334,870 | 10 | 235,549,826 |
| Remaining pool repeat no-cross exact-in reverse stage-100 | 2,472,108,717 | 0 | 2,374,425,979 |
| Remaining pool repeat no-cross exact-in reverse stage-1000 | 24,582,067,463 | 23 | 23,606,392,014 |
| Remaining pool repeat exact-out forward control | 24,982,755 | 0 | 23,975,429 |
| Remaining pool repeat exact-out reverse control | 24,310,669 | 0 | 23,329,817 |
...
| MultiHop ExactIn (3 hops) | 72,917,278 | 33 | 70,384,070 |
| MultiHop ExactOut (3 hops) | 111,753,067 | 0 | 108,413,764 |
| MultiRoute ExactIn (50:50 split) | 72,239,312 | 0 | 69,644,736 |
| MultiRoute ExactOut (50:50 split) | 97,839,123 | 4 | 94,723,630 |
...
| Swap (halving, 10 staked tick-crosses) | 107,352,243 | 3,729 | 102,822,596 |
| Swap (halving, 1 staked tick-cross) | 32,465,795 | 2,813 | 30,771,704 |
| Swap (halving, 50 staked tick-crosses) | 449,332,714 | 7,260 | 433,413,744 |
| Swap (no halving, 10 staked tick-crosses) | 95,177,363 | -7,110 | 91,044,466 |
| Swap (no halving, 1 staked tick-cross) | 26,270,128 | -7,684 | 24,852,502 |
| Swap (no halving, 50 staked tick-crosses) | 410,583,512 | -5,108 | 395,595,934 |
