...
| Swap (gns -> wugnot, fee:500) | 47,027,687 | 0 | 44,129,286 |
...
| CollectFee (with unwrap) | 7,922,064 | 44 | 5,945,168 |
| DecreaseLiquidity (w. Remove) | 22,323,226 | 62 | 19,402,448 |
| Mint (reposition) | 30,529,035 | 8,619 | 29,373,460 |
| SetPoolTier (tier 1) | 4,031,758 | 47,025 | 1,842,521 |
...
| ExactInSingleSwapRoute(grc20) - fee:10000 | 26,914,611 | 9,054 | 23,414,359 |
| ExactInSingleSwapRoute(grc20) - fee:100 | 31,505,331 | 9,054 | 27,909,735 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 26,978,948 | 9,054 | 23,459,876 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 26,841,185 | 9,054 | 23,341,173 |
| ExactInSwapRoute(grc20) - fee:10000 | 26,153,081 | 9,054 | 22,660,944 |
| ExactInSwapRoute(grc20) - fee:100 | 30,761,105 | 9,054 | 27,173,624 |
| ExactInSwapRoute(grc20) - fee:3000 | 26,226,070 | 9,054 | 22,715,113 |
| ExactInSwapRoute(grc20) - fee:500 | 26,096,959 | 9,054 | 22,605,062 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 28,747,612 | 9,054 | 25,221,541 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 33,189,108 | 9,054 | 29,570,306 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 28,687,965 | 9,054 | 25,142,842 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 28,583,750 | 9,054 | 25,057,687 |
| ExactOutSwapRoute(grc20) - fee:10000 | 28,009,117 | 9,054 | 24,491,166 |
| ExactOutSwapRoute(grc20) - fee:100 | 32,467,917 | 9,054 | 28,857,235 |
| ExactOutSwapRoute(grc20) - fee:3000 | 27,958,122 | 9,054 | 24,421,119 |
| ExactOutSwapRoute(grc20) - fee:500 | 27,862,559 | 9,054 | 24,344,616 |
| BuildSingleHopRoutePath | 202,459 | 0 | 47,814 |
| MultiHop ExactIn (2 hops) | 52,553,926 | 9,061 | 48,206,355 |
...
| Swap (halving, 10 staked tick-crosses) | 105,928,047 | 3,729 | 101,438,929 |
| Swap (halving, 1 staked tick-cross) | 32,121,765 | 2,813 | 30,432,703 |
| Swap (halving, 50 staked tick-crosses) | 443,093,670 | 7,260 | 427,387,117 |
| Swap (no halving, 10 staked tick-crosses) | 93,753,167 | -7,110 | 89,660,799 |
| Swap (no halving, 1 staked tick-cross) | 25,925,835 | -7,684 | 24,513,501 |
| Swap (no halving, 50 staked tick-crosses) | 404,344,468 | -5,108 | 389,569,307 |
