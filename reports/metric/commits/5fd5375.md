...
| Swap (gns -> wugnot, fee:500) | 47,030,252 | 0 | 44,129,286 |
...
| CollectFee (with unwrap) | 7,924,629 | 44 | 5,945,168 |
| DecreaseLiquidity (w. Remove) | 22,325,791 | 62 | 19,402,448 |
| Mint (reposition) | 30,529,035 | 8,619 | 29,373,460 |
| SetPoolTier (tier 1) | 4,034,323 | 47,025 | 1,842,521 |
...
| ExactInSingleSwapRoute(grc20) - fee:10000 | 26,917,176 | 9,054 | 23,414,359 |
| ExactInSingleSwapRoute(grc20) - fee:100 | 31,507,896 | 9,054 | 27,909,735 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 26,981,513 | 9,054 | 23,459,876 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 26,843,750 | 9,054 | 23,341,173 |
| ExactInSwapRoute(grc20) - fee:10000 | 26,155,646 | 9,054 | 22,660,944 |
| ExactInSwapRoute(grc20) - fee:100 | 30,763,670 | 9,054 | 27,173,624 |
| ExactInSwapRoute(grc20) - fee:3000 | 26,228,635 | 9,054 | 22,715,113 |
| ExactInSwapRoute(grc20) - fee:500 | 26,099,524 | 9,054 | 22,605,062 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 28,750,177 | 9,054 | 25,221,541 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 33,191,673 | 9,054 | 29,570,306 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 28,690,530 | 9,054 | 25,142,842 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 28,586,315 | 9,054 | 25,057,687 |
| ExactOutSwapRoute(grc20) - fee:10000 | 28,011,682 | 9,054 | 24,491,166 |
| ExactOutSwapRoute(grc20) - fee:100 | 32,470,482 | 9,054 | 28,857,235 |
| ExactOutSwapRoute(grc20) - fee:3000 | 27,960,687 | 9,054 | 24,421,119 |
| ExactOutSwapRoute(grc20) - fee:500 | 27,865,124 | 9,054 | 24,344,616 |
| BuildSingleHopRoutePath | 202,459 | 0 | 47,814 |
| MultiHop ExactIn (2 hops) | 52,556,491 | 9,061 | 48,206,355 |
...
| CollectReward reuse (2 active of 4; before 5-day warmup boundary) | 18,227,562 | 16,023 | 16,578,900 |
| CollectReward reuse (4 active; crosses 5-day warmup boundary) | 36,430,366 | 8,534 | 34,254,236 |
| CollectReward reuse repeated (4 active; post-boundary) | 27,781,418 | 72 | 25,909,217 |
