...
| SetPoolTier (tier 1) | 3,988,626 | 35,741 | 1,842,521 |
| StakeToken | 10,617,929 | 29,035 | 9,715,027 |
...
| Swap (halving, 10 staked tick-crosses) | 106,344,735 | 3,729 | 101,861,239 |
| Swap (halving, 1 staked tick-cross) | 32,139,123 | 2,813 | 30,474,934 |
| Swap (halving, 50 staked tick-crosses) | 445,285,158 | 7,260 | 429,498,667 |
| staker.NewIncentives (constructor + initial period) | 969,027 | 7,125 | 72,705 |
| staker.NewPool (constructor + seeded histories) | 395,454 | 34,700 | 232,000 |
...
| staker.Pool.rewardCache Set (#2) | 123,202 | 433 | 86,761 |
| staker.Pool.rewardCache Set (#3-4) | 233,399 | 770 | 160,034 |
| staker.Pool.rewardCache Set (#5) | 219,580 | 4,630 | 163,828 |
| staker.Pool.rewardCache Set (#6-13) | 1,303,303 | 7,278 | 925,712 |
| staker.Pool.rewardCache Set (#14) | 386,212 | 6,945 | 307,677 |
| staker.Pool.rewardCache Set (#15-63) | 12,058,562 | 80,196 | 8,876,419 |
| staker.Pool.rewardCache Set (#64) | 215,107 | 388 | 152,575 |
| staker.Pool.rewardCache Set (#65) | 316,540 | 2,453 | 241,540 |
| staker.Pool.rewardCache Set (#66-127) | 18,162,378 | 110,594 | 13,376,158 |
| staker.Pool.rewardCache Set (#128) | 620,711 | 7,126 | 507,847 |
| staker.Pool.rewardCache Set (#129) | 238,607 | 460 | 168,211 |
| staker.Pool.rewardCache Reverse newest | 187,794 | 0 | 179,760 |
| staker.Pool.rewardCache Reverse range (last 4) | 292,777 | 0 | 283,567 |
| staker.Pool.globalRewardRatioAccumulation Set (#2) | 146,957 | 459 | 93,481 |
| staker.Pool.globalRewardRatioAccumulation Set (#3-4) | 280,918 | 822 | 173,474 |
| staker.Pool.globalRewardRatioAccumulation Set (#5) | 151,672 | 411 | 96,711 |
| staker.Pool.globalRewardRatioAccumulation Set (#6-13) | 1,128,527 | 3,292 | 677,954 |
| staker.Pool.globalRewardRatioAccumulation Set (#14) | 159,839 | 412 | 100,419 |
| staker.Pool.globalRewardRatioAccumulation Set (#15-63) | 7,846,845 | 20,189 | 4,376,467 |
| staker.Pool.globalRewardRatioAccumulation Set (#64) | 194,288 | 414 | 110,109 |
| staker.Pool.globalRewardRatioAccumulation Set (#65) | 369,723 | 15,970 | 188,746 |
| staker.Pool.globalRewardRatioAccumulation Set (#66-127) | 12,384,946 | 25,685 | 7,141,506 |
| staker.Pool.globalRewardRatioAccumulation Set (#128) | 423,097 | 8,479 | 241,629 |
| staker.Pool.globalRewardRatioAccumulation Set (#129) | 203,022 | 438 | 131,714 |
...
| Swap (no halving, 10 staked tick-crosses) | 94,196,867 | -1,468 | 90,083,109 |
| Swap (no halving, 1 staked tick-cross) | 25,970,205 | -2,042 | 24,555,732 |
| Swap (no halving, 50 staked tick-crosses) | 406,562,968 | 534 | 391,680,857 |
