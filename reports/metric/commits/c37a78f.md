...
| Mint (fee:3000, wide range) | 17,998,639 | 20,464 | 11,982,885 |
| Swap (gns -> wugnot, fee:500) | 31,738,073 | 13,942 | 19,824,331 |
| DecreaseLiquidity | 14,497,840 | -2,106 | 12,330,189 |
| IncreaseLiquidity | 11,938,306 | -2,138 | 11,241,658 |
| Mint (bar:foo:500) | 21,475,377 | 20,463 | 11,159,481 |
| CollectFee (with unwrap) | 5,603,893 | 4,343 | 2,517,966 |
| DecreaseLiquidity (w. Remove) | 13,701,269 | 4,344 | 10,150,977 |
| Mint (reposition) | 13,258,707 | 15,086 | 12,009,099 |
| SetPoolTier (tier 1) | 4,541,230 | 21,548 | 1,449,066 |
| StakeToken | 10,345,954 | 22,172 | 6,678,939 |
| ExactInSingleSwapRoute(grc20) - fee:10000 | 29,115,625 | 4,181 | 10,423,817 |
| ExactInSingleSwapRoute(grc20) - fee:100 | 31,185,527 | 6,170 | 12,504,551 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 29,551,029 | 4,183 | 10,434,956 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 28,996,672 | 4,181 | 10,346,256 |
| ExactInSwapRoute(grc20) - fee:10000 | 28,853,066 | 4,181 | 10,161,258 |
| ExactInSwapRoute(grc20) - fee:100 | 30,929,512 | 6,170 | 12,248,536 |
| ExactInSwapRoute(grc20) - fee:3000 | 29,291,742 | 4,183 | 10,175,669 |
| ExactInSwapRoute(grc20) - fee:500 | 28,740,657 | 4,181 | 10,090,241 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 29,910,337 | 4,181 | 11,228,881 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 31,910,194 | 6,170 | 13,239,570 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 30,280,280 | 4,183 | 11,184,911 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 29,740,656 | 4,181 | 11,110,944 |
| ExactOutSwapRoute(grc20) - fee:10000 | 29,659,066 | 4,181 | 10,977,610 |
| ExactOutSwapRoute(grc20) - fee:100 | 31,665,467 | 6,170 | 12,994,843 |
| ExactOutSwapRoute(grc20) - fee:3000 | 30,032,281 | 4,183 | 10,936,912 |
| ExactOutSwapRoute(grc20) - fee:500 | 29,495,929 | 4,181 | 10,866,217 |
| BuildSingleHopRoutePath | 1,743,185 | 0 | 23,398 |
| MultiHop ExactIn (2 hops) | 30,293,360 | 8,186 | 20,754,727 |
| MultiHop ExactOut (2 hops) | 33,604,567 | 26 | 32,153,605 |
| MultiHop ExactIn (3 hops) | 32,228,750 | 4,029 | 30,111,988 |
| MultiHop ExactOut (3 hops) | 51,359,612 | 14 | 49,395,014 |
| MultiRoute ExactIn (50:50 split) | 32,508,816 | 2,009 | 29,922,687 |
| MultiRoute ExactOut (50:50 split) | 45,005,679 | 2 | 42,526,956 |
