...
| StakeToken | 10,621,507 | 24,521 | 9,715,027 |
...
| Swap (fee 100, 10 staked tick-crosses after accumulation) | 100,976,349 | 45,939 | 96,146,264 |
| Swap (fee 100, 100 staked tick-crosses after accumulation) | 883,808,036 | 440,578 | 846,623,818 |
| Swap (fee 100, 50 staked tick-crosses after accumulation) | 432,795,315 | 221,369 | 415,803,234 |
| Swap (fee 10000, 1 staked tick-crosses after accumulation) | 30,664,352 | 6,578 | 29,054,599 |
| Swap (fee 10000, 10 staked tick-crosses after accumulation) | 107,313,045 | 45,980 | 102,426,089 |
| Swap (fee 10000, 5 staked tick-crosses after accumulation) | 64,907,182 | 24,089 | 61,878,486 |
| Swap (fee 500, 1 staked tick-crosses after accumulation) | 29,739,657 | 6,575 | 28,145,227 |
| Swap (fee 500, 10 staked tick-crosses after accumulation) | 103,039,276 | 45,951 | 98,205,172 |
| Swap (fee 500, 50 staked tick-crosses after accumulation) | 447,078,672 | 221,449 | 429,898,379 |
...
| Swap (1 staked tick-cross after 4 prior tick checkpoints) | 33,547,879 | 3,338 | 32,085,209 |
| Swap (1 staked tick-cross after 8 prior tick checkpoints) | 33,604,150 | 3,350 | 32,136,031 |
| Swap (1 staked tick-cross after 16 prior tick checkpoints) | 33,820,385 | 9,839 | 32,292,799 |
| Swap (1 staked tick-cross after 32 prior tick checkpoints) | 33,818,451 | 3,362 | 32,306,078 |
| Swap (1 staked tick-cross after 64 prior tick checkpoints) | 33,878,746 | 3,506 | 32,356,436 |
| CollectReward after 65 tick checkpoints | 12,964,886 | 2,086 | 12,160,469 |
