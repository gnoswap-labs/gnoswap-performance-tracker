...
| ExactInSingleSwapRoute(grc20) - fee:10000 | 28,181,627 | 5,002 | 11,338,523 |
| ExactInSingleSwapRoute(grc20) - fee:100 | 30,230,406 | 7,819 | 13,385,846 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 28,604,606 | 5,004 | 11,355,365 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 28,062,354 | 5,002 | 11,260,962 |
| ExactInSingleSwapRoute(ugnot) - fee:10000 | 29,447,371 | 7,834 | 12,368,437 |
| ExactInSingleSwapRoute(ugnot) - fee:100 | 31,073,208 | 10,655 | 13,961,458 |
| ExactInSingleSwapRoute(ugnot) - fee:3000 | 29,968,173 | 7,836 | 12,472,670 |
| ExactInSingleSwapRoute(ugnot) - fee:500 | 29,317,422 | 7,835 | 12,259,320 |
| ExactInSwapRoute(grc20) - fee:10000 | 27,921,336 | 5,002 | 11,078,232 |
| ExactInSwapRoute(grc20) - fee:100 | 29,976,659 | 7,819 | 13,132,099 |
| ExactInSwapRoute(grc20) - fee:3000 | 28,347,587 | 5,004 | 11,098,346 |
| ExactInSwapRoute(grc20) - fee:500 | 27,808,607 | 5,002 | 11,007,215 |
| ExactInSwapRoute(ugnot) - fee:10000 | 29,187,080 | 7,834 | 12,108,146 |
| ExactInSwapRoute(ugnot) - fee:100 | 30,819,461 | 10,655 | 13,707,711 |
| ExactInSwapRoute(ugnot) - fee:3000 | 29,711,154 | 7,836 | 12,215,651 |
| ExactInSwapRoute(ugnot) - fee:500 | 29,063,675 | 7,835 | 12,005,573 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 28,971,983 | 5,002 | 12,139,231 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 30,950,025 | 7,819 | 14,115,817 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 29,329,421 | 5,004 | 12,100,964 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 28,801,902 | 5,002 | 12,021,294 |
| ExactOutSingleSwapRoute(ugnot) - fee:10000 | 29,844,621 | 7,844 | 12,467,301 |
| ExactOutSingleSwapRoute(ugnot) - fee:100 | 31,343,782 | 10,665 | 13,944,078 |
| ExactOutSingleSwapRoute(ugnot) - fee:3000 | 30,270,108 | 7,846 | 12,486,651 |
| ExactOutSingleSwapRoute(ugnot) - fee:500 | 29,643,208 | 7,845 | 12,297,152 |
| ExactOutSwapRoute(grc20) - fee:10000 | 28,722,980 | 5,002 | 11,890,228 |
| ExactOutSwapRoute(grc20) - fee:100 | 30,707,566 | 7,819 | 13,873,358 |
| ExactOutSwapRoute(grc20) - fee:3000 | 29,083,690 | 5,004 | 11,855,233 |
| ExactOutSwapRoute(grc20) - fee:500 | 28,559,443 | 5,002 | 11,778,835 |
| ExactOutSwapRoute(ugnot) - fee:10000 | 29,595,618 | 7,844 | 12,218,298 |
| ExactOutSwapRoute(ugnot) - fee:100 | 31,101,323 | 10,665 | 13,701,619 |
| ExactOutSwapRoute(ugnot) - fee:3000 | 30,024,377 | 7,846 | 12,240,920 |
| ExactOutSwapRoute(ugnot) - fee:500 | 29,400,749 | 7,845 | 12,054,693 |
| BuildSingleHopRoutePath | 1,710,230 | 0 | 23,398 |
| MultiHop ExactIn (2 hops) | 31,119,719 | 10,674 | 22,573,569 |
