...
| Swap (gns -> wugnot, fee:500) | 49,870,016 | 6 | 44,669,702 |
...
| CollectFee (with unwrap) | 9,307,111 | 44 | 6,817,051 |
| DecreaseLiquidity (w. Remove) | 25,141,513 | 72 | 20,768,337 |
| Mint (reposition) | 31,757,785 | 8,609 | 29,075,831 |
| SetPoolTier (tier 1) | 6,202,131 | 45,413 | 3,742,758 |
| StakeToken | 18,896,776 | 22,338 | 16,202,995 |
| ExactInSingleSwapRoute(grc20) - fee:100 | 34,227,543 | 8,961 | 28,926,294 |
| ExactInSingleSwapRoute(grc20) - fee:10000 | 29,307,250 | 8,961 | 24,347,448 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 29,575,398 | 8,961 | 24,495,707 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 29,233,227 | 8,961 | 24,278,430 |
| ExactInSwapRoute(grc20) - fee:100 | 33,419,039 | 8,961 | 28,182,993 |
| ExactInSwapRoute(grc20) - fee:10000 | 28,479,870 | 8,961 | 23,586,563 |
| ExactInSwapRoute(grc20) - fee:3000 | 28,757,456 | 8,961 | 23,743,614 |
| ExactInSwapRoute(grc20) - fee:500 | 28,424,723 | 8,961 | 23,535,129 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 36,009,968 | 8,961 | 30,605,998 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 31,255,639 | 8,961 | 26,179,913 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 31,391,387 | 8,961 | 26,202,626 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 31,085,244 | 8,961 | 26,019,617 |
| ExactOutSwapRoute(grc20) - fee:100 | 35,224,931 | 8,961 | 29,884,937 |
| ExactOutSwapRoute(grc20) - fee:10000 | 30,451,726 | 8,961 | 25,441,268 |
| ExactOutSwapRoute(grc20) - fee:3000 | 30,596,912 | 8,961 | 25,472,773 |
| ExactOutSwapRoute(grc20) - fee:500 | 30,300,207 | 8,961 | 25,298,556 |
| BuildSingleHopRoutePath | 203,722 | 0 | 48,894 |
| MultiHop ExactIn (2 hops) | 56,736,363 | 8,974 | 49,412,974 |
...
| staker CollectReward (1 external-incentive token) | 31,482,551 | 9,936 | 27,719,632 |
| staker CollectReward (2 external-incentive tokens) | 48,151,156 | 3,982 | 42,811,430 |
| staker CollectReward (3 external-incentive tokens) | 65,080,351 | 4,415 | 57,837,960 |
| staker CollectReward (4 external-incentive tokens) | 82,212,107 | 4,959 | 73,014,765 |
