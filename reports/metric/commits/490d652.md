...
| Swap (gns -> wugnot, fee:500) | 46,971,003 | 0 | 44,089,693 |
...
| CollectFee (with unwrap) | 7,921,557 | 44 | 5,945,168 |
| DecreaseLiquidity (w. Remove) | 22,322,719 | 62 | 19,402,448 |
| Mint (reposition) | 30,529,035 | 8,619 | 29,373,460 |
| SetPoolTier (tier 1) | 4,031,251 | 47,025 | 1,842,521 |
...
| ExactInSingleSwapRoute(grc20) - fee:100 | 31,447,603 | 9,054 | 27,869,098 |
| ExactInSingleSwapRoute(grc20) - fee:10000 | 26,856,882 | 9,054 | 23,373,721 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 26,894,298 | 9,054 | 23,411,370 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 26,784,501 | 9,054 | 23,301,580 |
| ExactInSwapRoute(grc20) - fee:100 | 30,703,377 | 9,054 | 27,132,987 |
| ExactInSwapRoute(grc20) - fee:10000 | 26,095,352 | 9,054 | 22,620,306 |
| ExactInSwapRoute(grc20) - fee:3000 | 26,141,420 | 9,054 | 22,666,607 |
| ExactInSwapRoute(grc20) - fee:500 | 26,040,275 | 9,054 | 22,565,469 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 33,131,380 | 9,054 | 29,529,669 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 28,689,883 | 9,054 | 25,180,903 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 28,603,315 | 9,054 | 25,094,336 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 28,527,066 | 9,054 | 25,018,094 |
| ExactOutSwapRoute(grc20) - fee:100 | 32,410,189 | 9,054 | 28,816,598 |
| ExactOutSwapRoute(grc20) - fee:10000 | 27,951,388 | 9,054 | 24,450,528 |
| ExactOutSwapRoute(grc20) - fee:3000 | 27,873,472 | 9,054 | 24,372,613 |
| ExactOutSwapRoute(grc20) - fee:500 | 27,805,875 | 9,054 | 24,305,023 |
| BuildSingleHopRoutePath | 202,459 | 0 | 47,814 |
| MultiHop ExactIn (2 hops) | 52,455,171 | 9,061 | 48,127,175 |
| MultiHop ExactOut (2 hops) | 72,905,165 | 76 | 70,577,868 |
| MultiHop ExactIn (3 hops) | 72,010,154 | 33 | 69,493,026 |
| MultiHop ExactOut (3 hops) | 110,518,487 | 0 | 107,204,360 |
| MultiRoute ExactIn (50:50 split) | 71,301,732 | 0 | 68,743,191 |
| MultiRoute ExactOut (50:50 split) | 96,677,491 | 4 | 93,586,504 |
| Swap (halving, 1 staked tick-cross) | 32,106,377 | 2,813 | 30,418,835 |
| Swap (halving, 10 staked tick-crosses) | 106,314,176 | 3,729 | 101,807,588 |
| Swap (halving, 50 staked tick-crosses) | 445,264,319 | 7,260 | 429,455,896 |
| Swap (staked pool, no staked tick-cross) | 16,227,716 | 0 | 15,374,262 |
| Swap (no halving, 1 staked tick-cross) | 25,910,447 | -7,684 | 24,499,633 |
| Swap (no halving, 10 staked tick-crosses) | 94,139,296 | -7,110 | 90,029,458 |
| Swap (no halving, 50 staked tick-crosses) | 406,515,117 | -5,108 | 391,638,086 |
