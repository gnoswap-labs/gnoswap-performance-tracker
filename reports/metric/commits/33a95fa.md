...
| Swap with no reachable liquidity (gns -> wugnot, fee:500) | 1,224,929,296 | 36 | 1,196,023,131 |
| Swap (gns -> wugnot, fee:500) | 46,902,966 | -6 | 44,144,103 |
...
| ExactInSingleSwapRoute(grc20) - fee:100 | 31,380,610 | 9,048 | 27,924,552 |
| ExactInSingleSwapRoute(grc20) - fee:10000 | 26,789,890 | 9,048 | 23,429,176 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 26,854,227 | 9,048 | 23,474,693 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 26,716,464 | 9,048 | 23,355,990 |
| ExactInSwapRoute(grc20) - fee:100 | 30,636,384 | 9,048 | 27,188,441 |
| ExactInSwapRoute(grc20) - fee:10000 | 26,028,360 | 9,048 | 22,675,761 |
| ExactInSwapRoute(grc20) - fee:3000 | 26,101,349 | 9,048 | 22,729,930 |
| ExactInSwapRoute(grc20) - fee:500 | 25,972,238 | 9,048 | 22,619,879 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 33,064,387 | 9,048 | 29,585,123 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 28,622,891 | 9,048 | 25,236,358 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 28,563,244 | 9,048 | 25,157,659 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 28,459,029 | 9,048 | 25,072,504 |
| ExactOutSwapRoute(grc20) - fee:100 | 32,343,196 | 9,048 | 28,872,052 |
| ExactOutSwapRoute(grc20) - fee:10000 | 27,884,396 | 9,048 | 24,505,983 |
| ExactOutSwapRoute(grc20) - fee:3000 | 27,833,401 | 9,048 | 24,435,936 |
| ExactOutSwapRoute(grc20) - fee:500 | 27,737,838 | 9,048 | 24,359,433 |
| BuildSingleHopRoutePath | 202,459 | 0 | 47,814 |
| MultiHop ExactIn (2 hops) | 52,292,406 | 9,049 | 48,235,989 |
| MultiHop ExactOut (2 hops) | 72,728,291 | 76 | 70,686,682 |
| MultiHop ExactIn (3 hops) | 71,744,887 | 21 | 69,656,243 |
| MultiHop ExactOut (3 hops) | 110,253,220 | 0 | 107,367,577 |
| MultiRoute ExactIn (50:50 split) | 71,064,342 | -6 | 68,915,328 |
| MultiRoute ExactOut (50:50 split) | 96,421,822 | 4 | 93,758,641 |
| Swap (halving, 1 staked tick-cross) | 32,078,710 | 2,807 | 30,491,490 |
| Swap (halving, 10 staked tick-crosses) | 106,284,322 | 3,723 | 101,877,795 |
| Swap (halving, 50 staked tick-crosses) | 445,224,745 | 7,254 | 429,515,223 |
| Swap (no halving, 1 staked tick-cross) | 25,882,780 | -7,690 | 24,572,288 |
| Swap (no halving, 10 staked tick-crosses) | 94,109,442 | -7,116 | 90,099,665 |
| Swap (no halving, 50 staked tick-crosses) | 406,475,543 | -5,114 | 391,697,413 |
