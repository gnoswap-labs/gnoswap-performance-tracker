...
| CollectReward (1 delegation, 10 withdraws) | 4,897,609 | 10,192 | 3,999,837 |
| CollectReward (1 delegation, 1 withdraws) | 5,091,316 | 10,192 | 4,190,078 |
| CollectReward (1 delegation, 50 withdraws) | 4,894,402 | 10,192 | 3,996,630 |
| CollectReward (1 delegation, 5 withdraws) | 4,895,555 | 10,192 | 3,997,783 |
| gov/staker CollectReward (1 protocol-fee tokens) | 5,081,567 | 8,169 | 4,186,311 |
...
| Delegate | 5,322,046 | 48,729 | 2,084,576 |
| Undelegate | 2,535,431 | 2,487 | 1,731,961 |
...
| Redelegate | 4,910,643 | 4,669 | 3,374,743 |
...
| CollectProtocolFee (1 token) | 4,936,694 | 12,227 | 4,114,168 |
| CollectProtocolFee (2 tokens) | 8,621,106 | 24,276 | 7,350,039 |
| CollectProtocolFee (5 tokens) | 19,814,528 | 60,459 | 17,158,049 |
...
| ExactInSingleSwapRoute(grc20) - fee:10000 | 28,541,715 | 23,269 | 24,730,565 |
| ExactInSingleSwapRoute(grc20) - fee:100 | 33,132,379 | 23,269 | 29,225,885 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 28,606,523 | 23,269 | 24,776,058 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 28,468,237 | 23,269 | 24,657,327 |
| ExactInSwapRoute(grc20) - fee:10000 | 27,780,185 | 23,269 | 23,977,150 |
| ExactInSwapRoute(grc20) - fee:100 | 32,388,153 | 23,269 | 28,489,774 |
| ExactInSwapRoute(grc20) - fee:3000 | 27,853,645 | 23,269 | 24,031,295 |
| ExactInSwapRoute(grc20) - fee:500 | 27,724,011 | 23,269 | 23,921,216 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 30,374,740 | 23,269 | 26,537,771 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 34,816,180 | 23,269 | 30,886,480 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 30,315,564 | 23,269 | 26,459,048 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 30,210,826 | 23,269 | 26,373,865 |
| ExactOutSwapRoute(grc20) - fee:10000 | 29,636,245 | 23,269 | 25,807,396 |
| ExactOutSwapRoute(grc20) - fee:100 | 34,094,989 | 23,269 | 30,173,409 |
| ExactOutSwapRoute(grc20) - fee:3000 | 29,585,721 | 23,269 | 25,737,325 |
| ExactOutSwapRoute(grc20) - fee:500 | 29,489,635 | 23,269 | 25,660,794 |
| BuildSingleHopRoutePath | 203,089 | 0 | 46,890 |
| MultiHop ExactIn (2 hops) | 53,601,607 | 23,276 | 48,958,907 |
...
| MultiRoute ExactIn (50:50 split) | 73,009,132 | 0 | 70,389,984 |
