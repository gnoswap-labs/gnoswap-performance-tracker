...
| Swap (gns -> wugnot, fee:500) | 49,876,082 | 6 | 44,669,702 |
...
| CollectFee (with unwrap) | 9,313,177 | 44 | 6,817,051 |
| DecreaseLiquidity (w. Remove) | 25,147,579 | 72 | 20,768,337 |
| Mint (reposition) | 31,757,785 | 8,609 | 29,075,831 |
| SetPoolTier (tier 1) | 6,208,197 | 45,413 | 3,742,758 |
| StakeToken | 18,723,069 | 22,308 | 16,239,485 |
| ExactInSingleSwapRoute(grc20) - fee:10000 | 29,313,316 | 8,961 | 24,347,448 |
| ExactInSingleSwapRoute(grc20) - fee:100 | 34,233,609 | 8,961 | 28,926,294 |
| ExactInSingleSwapRoute(grc20) - fee:3000 | 29,384,653 | 8,961 | 24,396,961 |
| ExactInSingleSwapRoute(grc20) - fee:500 | 29,239,293 | 8,961 | 24,278,430 |
| ExactInSwapRoute(grc20) - fee:10000 | 28,485,936 | 8,961 | 23,586,563 |
| ExactInSwapRoute(grc20) - fee:100 | 33,425,105 | 8,961 | 28,182,993 |
| ExactInSwapRoute(grc20) - fee:3000 | 28,566,711 | 8,961 | 23,644,868 |
| ExactInSwapRoute(grc20) - fee:500 | 28,430,789 | 8,961 | 23,535,129 |
| ExactOutSingleSwapRoute(grc20) - fee:10000 | 31,261,705 | 8,961 | 26,179,913 |
| ExactOutSingleSwapRoute(grc20) - fee:100 | 36,016,034 | 8,961 | 30,605,998 |
| ExactOutSingleSwapRoute(grc20) - fee:3000 | 31,200,642 | 8,961 | 26,103,880 |
| ExactOutSingleSwapRoute(grc20) - fee:500 | 31,091,310 | 8,961 | 26,019,617 |
| ExactOutSwapRoute(grc20) - fee:10000 | 30,457,792 | 8,961 | 25,441,268 |
| ExactOutSwapRoute(grc20) - fee:100 | 35,230,997 | 8,961 | 29,884,937 |
| ExactOutSwapRoute(grc20) - fee:3000 | 30,406,167 | 8,961 | 25,374,027 |
| ExactOutSwapRoute(grc20) - fee:500 | 30,306,273 | 8,961 | 25,298,556 |
| BuildSingleHopRoutePath | 203,722 | 0 | 48,894 |
| MultiHop ExactIn (2 hops) | 56,742,429 | 8,974 | 49,412,974 |
...
| MultiRoute ExactIn (50:50 split) | 77,936,094 | 6 | 70,943,202 |
| MultiRoute ExactOut (50:50 split) | 105,698,335 | 4 | 96,794,082 |
| CollectReward (only Internal Reward) | 29,337,647 | 11,503 | 25,551,416 |
| CollectReward 2nd (only Internal Reward) | 29,554,552 | 491 | 26,069,447 |
...
| storage growth: CollectReward 20 staked positions | 34,076,324 | 513 | 30,285,323 |
| storage growth: CollectReward 40 staked positions | 34,123,880 | 453 | 30,323,494 |
| storage growth: CollectReward 60 staked positions | 34,136,865 | 466 | 30,404,673 |
| storage growth: CollectReward 80 staked positions | 34,303,079 | 454 | 30,545,462 |
| storage growth: CollectReward 100 staked positions | 34,308,764 | 454 | 30,538,915 |
| CollectReward with Warmup Range (30% ~ 30%) | 29,358,962 | 11,484 | 25,566,178 |
| CollectReward with Warmup Range (30% ~ 50%) | 35,556,609 | 513 | 31,554,746 |
| CollectReward with Warmup Range (30% ~ 70%) | 41,602,870 | 473 | 37,076,473 |
| CollectReward with Warmup Range (30% ~ 100%) | 47,619,979 | 474 | 42,571,559 |
| CollectReward with Warmup Range (100% ~) | 29,527,935 | 450 | 26,135,765 |
| CollectReward with Warmup Range 2nd (100% ~) | 29,405,792 | 456 | 26,012,806 |
